 ...
 * @author davis
 */
public class MedicomAppLoader implements HRMBusinessPlugin {

        public MedicomAppLoader() {
        }
        ...
        public void init(HRMSystemContext context) throws HRMBusinessPluginException {
                ...
                dp.register_controller_call(new CEPatientData(), CEPatientData.class.getSimpleName(),
